...
interface CoolEyeForGangstersInterface extends ethers.utils.Interface {
  functions: {
...
export class CoolEyeForGangsters extends BaseContract {
  ...
  interface: CoolEyeForGangstersInterface;
